...
export enum AdminUserListSortBy {
...
export class GetAdminUsersQueryDto {
  ...
  @ApiPropertyOptional({
    enum: AdminUserListSortBy,
    enumName: 'AdminUserListSortBy',
    default: AdminUserListSortBy.CREATED_AT,
  })
  @IsOptional()
  @IsEnum(AdminUserListSortBy)
  sortBy: AdminUserListSortBy = AdminUserListSortBy.CREATED_AT;
